						...
						<div class="mt-3">
							<ul>
								<c:forEach var="file" items="${article.fileInfos}" >
									<img src="${root}/upload/file/${file.saveFolder }/${file.saveFile}"width = "250px">
									<li>${file.originalFile} <a href="${root}/board/download" class="filedown" sfolder="${file.saveFolder}" sfile="${file.saveFile}" ofile="${file.originalFile}">[다운로드]</a>
								</c:forEach>
							</ul>
						</div>
						</c:if>
